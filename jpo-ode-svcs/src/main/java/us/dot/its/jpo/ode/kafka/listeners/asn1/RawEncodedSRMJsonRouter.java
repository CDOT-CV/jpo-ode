...
public class RawEncodedSRMJsonRouter {
  ...
  private static final SupportedMessageType MESSAGE_TYPE = SupportedMessageType.SRM;
   ...
   */
  public RawEncodedSRMJsonRouter(ObjectMapper mapper,
  ...
  public void listen(ConsumerRecord<String, String> consumerRecord)
    ...
    JSONObject rawSrmJsonObject = new JSONObject(consumerRecord.value());

    String jsonStringMetadata = rawSrmJsonObject.get("metadata").toString();
    OdeSrmMetadata metadata = mapper.readValue(jsonStringMetadata, OdeSrmMetadata.class);
    ...
    String payloadHexString =
        ((JSONObject) ((JSONObject) rawSrmJsonObject.get("payload")).get("data"))
            .getString("bytes");
