...
public class RawEncodedSPATJsonRouter {
  ...
  private static final SupportedMessageType MESSAGE_TYPE = SupportedMessageType.SPAT;
   ...
   */
  public RawEncodedSPATJsonRouter(ObjectMapper mapper,
  ...
  public void listen(ConsumerRecord<String, String> consumerRecord)
    ...
    JSONObject rawSpatJsonObject = new JSONObject(consumerRecord.value());

    String jsonStringMetadata = rawSpatJsonObject.get("metadata").toString();
    OdeSpatMetadata metadata = mapper.readValue(jsonStringMetadata, OdeSpatMetadata.class);
    ...
    String payloadHexString =
        ((JSONObject) ((JSONObject) rawSpatJsonObject.get("payload")).get("data"))
            .getString("bytes");
