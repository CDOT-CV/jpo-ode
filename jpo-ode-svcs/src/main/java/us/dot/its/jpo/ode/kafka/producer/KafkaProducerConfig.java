...
public class KafkaProducerConfig {
   ...
   * and OdeBsmData values. This factory utilizes the provided producer properties,
   * along with specific serializers for the key and value types.
   *
  ...
  /**
   * Creates a KafkaTemplate specifically configured for handling messages with String keys
   * and OdeBsmData values. This KafkaTemplate incorporates a DisabledTopicsProducerInterceptor
   * to block messages being sent to disabled topics and a LoggingProducerListener for
   * logging producer activity.
   *
   * @param producerFactory the ProducerFactory used to create Kafka producers for
   *                        sending messages with String keys and OdeBsmData values.
   *                        Configures the necessary serializers and properties.
   * @return a KafkaTemplate instance configured for publishing messages to Kafka topics
   *         with String keys and OdeBsmData values, ensuring proper handling of disabled
   *         topics and logging.
   */
  @Bean
