...
public class RawEncodedSSMJsonRouter {
  ...
  private static final SupportedMessageType MESSAGE_TYPE = SupportedMessageType.SSM;
   ...
   */
  public RawEncodedSSMJsonRouter(ObjectMapper mapper,
  ...
  public void listen(ConsumerRecord<String, String> consumerRecord)
    ...
    JSONObject rawSsmJsonObject = new JSONObject(consumerRecord.value());

    String jsonStringMetadata = rawSsmJsonObject.get("metadata").toString();
    OdeSsmMetadata metadata = mapper.readValue(jsonStringMetadata, OdeSsmMetadata.class);
    ...
    String payloadHexString =
        ((JSONObject) ((JSONObject) rawSsmJsonObject.get("payload")).get("data"))
            .getString("bytes");
