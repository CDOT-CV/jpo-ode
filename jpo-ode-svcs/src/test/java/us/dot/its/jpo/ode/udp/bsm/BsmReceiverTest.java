...
class BsmReceiverTest {
    ...
    static Stream<Arguments> testInputs() {
        String base = "src/test/resources/us/dot/its/jpo/ode/udp/bsm/";
        return Stream.of(
                Arguments.of("raw J2735 no headers", base + "BsmReceiverTest_ValidBSM.txt",
                        base + "BsmReceiverTest_ValidBSM_expected.json"),
                Arguments.of("with 1609.2 message signature",
                        base + "BsmReceiverTest_ValidBSM_WithSignature.txt",
    ...
    void testRun(String description, String inputFile, String expectedFile) throws Exception {
        ...
        TestUDPClient udpClient =
                new TestUDPClient(udpReceiverProperties.getBsm().getReceiverPort());
