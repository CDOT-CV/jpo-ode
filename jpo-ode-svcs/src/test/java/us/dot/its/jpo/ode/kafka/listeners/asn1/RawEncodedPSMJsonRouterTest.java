...
@SpringBootTest(classes = {OdeKafkaProperties.class, KafkaProducerConfig.class,
                KafkaConsumerConfig.class, KafkaProperties.class, RawEncodedPSMJsonRouter.class,
                RawEncodedJsonService.class, SerializationConfig.class, TestMetricsConfig.class,},
                properties = {"ode.kafka.topics.raw-encoded-json.psm=topic.Asn1DecoderTestPSMJSON",
...
class RawEncodedPSMJsonRouterTest {
        ...
        void testListen() throws JSONException, IOException {
                ...
                Map<String, Object> consumerProps = KafkaTestUtils.consumerProps(
                                "RawEncodedPSMJsonRouterTest", "false", embeddedKafka);
                ...
                var produced = KafkaTestUtils.getSingleRecord(testConsumer,
                                asn1CoderTopics.getDecoderInput());
