...
@SpringBootTest(classes = {KafkaProducerConfig.class, KafkaConsumerConfig.class,
                RawEncodedSSMJsonRouter.class, RawEncodedJsonService.class,
                SerializationConfig.class, TestMetricsConfig.class,},
                properties = {"ode.kafka.topics.raw-encoded-json.ssm=topic.Asn1DecoderTestSSMJSON",
...
class RawEncodedSSMJsonRouterTest {
        ...
        void testListen() throws JSONException, IOException {
                ...
                Map<String, Object> consumerProps = KafkaTestUtils.consumerProps(
                                "Asn1DecodeSSMJSONTestConsumer", "false", embeddedKafka);
                ...
                inputStream = classLoader.getResourceAsStream(
                                "us/dot/its/jpo/ode/kafka/listeners/asn1/expected-ssm.xml");
                assert inputStream != null;
                var expectedSSM = new String(inputStream.readAllBytes(), StandardCharsets.UTF_8);

                var consumedSSM = KafkaTestUtils.getSingleRecord(testConsumer,
                                asn1CoderTopics.getDecoderInput());
