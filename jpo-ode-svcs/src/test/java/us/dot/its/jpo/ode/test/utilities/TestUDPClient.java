...
/**
 * TestUDPClient is a utility class used for sending UDP packets to a specified port.
 * It encapsulates the creation of a DatagramSocket and the logic to send data
 * packets to a local server.
 */
@Slf4j
public class TestUDPClient {
  ...
  /**
   * Constructs a new TestUDPClient instance configured to send UDP packets
   * to the specified port on the localhost.
   *
  ...
  /**
   * Sends a UDP packet containing the specified message to the configured port
   * on the localhost. The message is converted from a hexadecimal string to a
   * byte array before being sent.
   *
