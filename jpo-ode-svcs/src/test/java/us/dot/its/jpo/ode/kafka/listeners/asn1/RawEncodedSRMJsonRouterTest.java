...
@SpringBootTest(classes = {KafkaProducerConfig.class, KafkaConsumerConfig.class,
                RawEncodedSRMJsonRouter.class, RawEncodedJsonService.class,
                SerializationConfig.class, TestMetricsConfig.class,},
                properties = {"ode.kafka.topics.raw-encoded-json.srm=topic.Asn1DecoderTestSRMJSON",
...
class RawEncodedSRMJsonRouterTest {
        ...
        void testListen() throws JSONException, IOException {
                ...
                Map<String, Object> consumerProps = KafkaTestUtils.consumerProps(
                                "Asn1DecodeSRMJSONTestConsumer", "false", embeddedKafka);
                ...
                var producedSrm = KafkaTestUtils.getSingleRecord(testConsumer,
                                asn1CoderTopics.getDecoderInput());
