...
/**
 * Represents a service request containing ODE, SDW, RSU, and SNMP information.
 */
public class ServiceRequest extends OdeObject {

  /**
   * Internal ODE request details including version and request verb.
   */
  public static class OdeInternal extends OdeObject {
    ...
    /**
     * Constructs an OdeInternal object with the specified version and request verb.
     *
     * @param version the version number to set
     * @param verb the HTTP request verb to set
     */
